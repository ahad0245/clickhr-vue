<template>
  <div class="modern-template font-sans border rounded-lg overflow-hidden shadow-lg p-6">
    <div class="header pb-4 mb-6 border-b-4 border-blue-700">
      <h1 class="text-4xl font-extrabold text-gray-800">{{ resume.personal.first_name || '' }} {{ resume.personal.last_name || '' }}</h1>
      <h2 class="text-xl font-medium text-blue-700">{{ resume.personal.headline || '' }}</h2>
    ...
    <section v-if="resume.additional.resume_text" class="mb-6">
      <h3 class="text-xl font-bold text-gray-800 border-b-2 border-blue-500 pb-1">Summary</h3>
    ...
    <section v-if="resume.history.work_history && resume.history.work_history.length" class="mb-6">
      <h3 class="text-xl font-bold text-gray-800 border-b-2 border-blue-500 pb-1">Experience</h3>
    ...
    <section v-if="resume.history.education_history && resume.history.education_history.length" class="mb-6">
      <h3 class="text-xl font-bold text-gray-800 border-b-2 border-blue-500 pb-1">Education</h3>
    ...
    <section v-if="resume.certifications && resume.certifications.length" class="mb-6">
      <h3 class="text-xl font-bold text-gray-800 border-b-2 border-blue-500 pb-1">Certifications</h3>
    ...
    <section v-if="resume.employment.applicant_tags">
      <h3 class="text-xl font-bold text-gray-800 border-b-2 border-blue-500 pb-1">Skills</h3>
